...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span class='upload-text'>Kéo hoặc thả tập tin vào đây</span>",
            abortStr: "Ngừng",
            cancelStr: "Hủy",
            deletelStr: "Xóa",
            doneStr: "Xong",
            multiDragErrorStr: "Không cho phép kéo thả quá nhiều tập tin.",
            extErrorStr: " không được phép upload. Bạn chỉ được phép upload các tập tin: ",
            sizeErrorStr: " không được phép upload. Kích thước tối đa bạn được phép upload là: ",
